...
--
-- Host: localhost
-- Generation Time: Apr 03, 2011 at 06:37 PM
...
-- Database: `ides_db`
--
CREATE DATABASE `ides_db` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `ides_db`;
...
CREATE TABLE IF NOT EXISTS `grouptable` (
  ...
  `grp_website` varchar(255) DEFAULT NULL,
  `grp_abstract` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`grp_id`)
...
INSERT INTO `grouptable` (`grp_id`, `grp_name`, `grp_website`, `grp_abstract`) VALUES
(1, 'RIM', 'http://www.rim.ca', 'we create shit for RIM');
...
(34, 'Cory', 'McMAHON', NULL, NULL, NULL, NULL, 'st', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
